...
//
//public class SpiceJetCalendor extends ReusableSeleniumScript {
//
...
//		String expectedmonth = By.xpath("//*[@id=ui-datepicker-div]/div[1]/div/div/span[1]").linkText("December");
//
//	}
//
//}
...
public class SpiceJetCalendor extends ReusableSeleniumScript{
	public static void main(String[] args) throws InterruptedException {
        ...
        WebElement selectDate = driver.findElement(By.xpath("//*[@id=\"marketDate_1\"]/button"));
         selectDate.click();
