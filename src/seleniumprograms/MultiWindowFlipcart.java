...
// find an item
		...
		for (WebElement pageWebElement : allPaginationPages) {
			...
			boolean flag = false;
			String findMobile = "Samsung Galaxy A20 (Gold, 32 GB)";// "Samsung Galaxy A20 (Red, 32 GB)"; // "Samsung
																	// Galaxy A50s (Prism Crush Violet, 128 GB)"
...
// By.xpath("//*[@id='container']/div/div[3]/div[1]/div[1]/div[2]/div/ul/li[2]/form/button")).click(); // click on Buy Now button
						By.xpath("//*[@id=\"container\"]/div/div[3]/div[1]/div[1]/div[2]/div/ul/li[1]/button")).click(); // click
																															// on
																															// Add
																															// to
																															// card
